#ifndef transitionLib846_PREF_H_
#define transitionLib846_PREF_H_
...
class Pref {
 public:
  ...
  Pref(const transitionLib846::Named& parent, std::string name, T fallback);
...
template <class U>
Pref<U>::Pref(const transitionLib846::Named& parent, std::string name, U fallback)
    : Pref{parent,
           fmt::format("{} ({})", name,
...
template <>
inline Pref<bool>::Pref(const transitionLib846::Named& parent, std::string name,
                        bool fallback)
    : Pref<bool>{
          parent,
          name,
...
template <>
inline Pref<double>::Pref(const transitionLib846::Named& parent, std::string name,
                          double fallback)
    : Pref<double>{
          parent,
          name,
...
template <>
inline Pref<int>::Pref(const transitionLib846::Named& parent, std::string name,
                       int fallback)
    : Pref<int>{
          parent,
          name,
...
template <>
inline Pref<std::string>::Pref(const transitionLib846::Named& parent, std::string name,
                               std::string fallback)
    : Pref<std::string>{
          parent,
          name,
...
#endif  // transitionLib846_PREF_H_