...
TEST(GrapherTest, Graph) {
  ...
  transitionLib846::Grapher<units::inch_t> g1{named, "g1"};
  transitionLib846::Grapher<bool> g2{named, "g2"};
  transitionLib846::Grapher<double> g3{named, "g3"};
  transitionLib846::Grapher<int> g4{named, "g4"};
  transitionLib846::Grapher<std::string> g5{named, "g5"};
