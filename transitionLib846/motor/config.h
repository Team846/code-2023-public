#ifndef transitionLib846_MOTOR_CONFIG_H_
#define transitionLib846_MOTOR_CONFIG_H_
...
class VictorSPXConfigHelper : public Named {
 public:
  ...
  transitionLib846::Pref<double> peak_output_;
  transitionLib846::Pref<units::volt_t> voltage_comp_saturation_;
...
class TalonSRXConfigHelper : public Named {
 public:
  ...
  transitionLib846::Pref<units::ampere_t> peak_current_limit_;
  transitionLib846::Pref<units::millisecond_t> peak_current_duration_;
  transitionLib846::Pref<units::ampere_t> continuous_current_limit_;
...
class TalonFXConfigHelper : public Named {
 public:
  ...
  transitionLib846::Pref<units::ampere_t> supply_peak_current_limit_;
  transitionLib846::Pref<units::millisecond_t> supply_peak_current_duration_;
  transitionLib846::Pref<units::ampere_t> supply_continuous_current_limit_;

  transitionLib846::Pref<units::ampere_t> stator_peak_current_limit_;
  transitionLib846::Pref<units::millisecond_t> stator_peak_current_duration_;
  transitionLib846::Pref<units::ampere_t> stator_continuous_current_limit_;
...
class SparkMAXConfigHelper : public Named {
 public:
  ...
  transitionLib846::Pref<units::ampere_t> current_limit_;
...
#endif  // transitionLib846_MOTOR_CONFIG_H_