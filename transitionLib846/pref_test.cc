...
class PrefTest : public testing::Test {
 protected:
  transitionLib846::Named named{"root"};

  transitionLib846::Pref<bool> p1{named, "p1", true};
  transitionLib846::Pref<double> p2{named, "p2", 8.46};
  transitionLib846::Pref<int> p3{named, "p3", 846};
  transitionLib846::Pref<std::string> p4{named, "p4", "846"};
  transitionLib846::Pref<units::inch_t> p5{named, "p5", 8.46_in};
};
