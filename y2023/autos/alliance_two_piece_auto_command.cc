...
AllianceTwoPieceAutoCommand::AllianceTwoPieceAutoCommand(
    RobotContainer& container, bool should_flip)
    : should_flip_(should_flip) {
  SetName("AllianceTwoPieceAutoCommand" +
  ...
  AddCommands(
      ...
      frc2::ParallelDeadlineGroup{
          FollowTrajectoryCommand{
              container,
              {{field::points::kIntermediaryAlliance(should_flip_), 9_fps},
      ...
      frc2::ParallelDeadlineGroup{
          FollowTrajectoryCommand{
              container,
              {{field::points::kIntermediaryAlliance(should_flip_), 6_fps},
      ...
      frc2::ParallelDeadlineGroup{
        //   FollowTrajectoryCommand{
        //       container,
        //       {{field::points::kIntermediaryAlliance(should_flip_), 2_fps}}},
          GripperCommand{container,
                         container.gripper_.subsystem()->place_speed_},
          RetractCommand{
              container, container.pivot_.subsystem()->cube_conveyor_position_,
