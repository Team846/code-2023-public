#ifndef Y2023_COMMANDS_AUTO_EXTEND_COMMAND_H_
#define Y2023_COMMANDS_AUTO_EXTEND_COMMAND_H_
...
class AutoExtendCommand
    : public frc2::CommandHelper<frc2::CommandBase, AutoExtendCommand> {
 public:
  AutoExtendCommand(RobotContainer& container,
...
#endif  // Y2023_COMMANDS_AUTO_EXTEND_COMMAND_H_